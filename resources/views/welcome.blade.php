...
<body class="min-h-screen overflow-x-hidden bg-slate-950 text-white antialiased">
    ...
    <div class="fixed inset-0 -z-10">
        ...
        <div class="absolute top-0 left-0 h-[500px] w-[500px] rounded-full bg-indigo-600/20 blur-3xl">
        </div>

        <div class="absolute bottom-0 right-0 h-[500px] w-[500px] rounded-full bg-cyan-500/20 blur-3xl">
        </div>

        <div class="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.06),transparent_30%)]">
        </div>
            ...
            <div class="flex items-center gap-3">
                ...
                @auth
                    ...
                    <a href="{{ url('/dashboard') }}"
                        class="inline-flex items-center gap-2 rounded-2xl bg-indigo-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/20 transition hover:-translate-y-0.5 hover:bg-indigo-500">

                        Dashboard

                    </a>
                @else
                    <a href="{{ route('login') }}" class="text-sm font-medium text-slate-300 transition hover:text-white">
                        Login
                    </a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-5 py-3 text-sm font-semibold text-white backdrop-blur-xl transition hover:bg-white/10">
    ...
    <!-- Hero -->
    <main class="relative mx-auto flex max-w-7xl flex-col items-center px-6 pt-20 pb-24 text-center">
        ...
        <!-- Heading -->
        <h1 class="max-w-5xl text-5xl font-black leading-tight tracking-tight text-white md:text-7xl">
        ...
        <div class="mt-10 flex flex-col items-center gap-4 sm:flex-row">
            ...
            <a href="{{ route('login') }}"
                class="inline-flex items-center gap-2 rounded-2xl bg-indigo-600 px-8 py-4 text-sm font-semibold text-white shadow-2xl shadow-indigo-500/30 transition hover:-translate-y-1 hover:bg-indigo-500">
            ...
            <a href="#features"
                class="inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-8 py-4 text-sm font-semibold text-white backdrop-blur-xl transition hover:bg-white/10">
        ...
        <!-- Dashboard Preview -->
        <div
            class="relative mt-20 w-full overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 shadow-2xl backdrop-blur-2xl">
            ...
            <div class="relative p-6">
                ...
                <!-- Top Bar -->
                <div
                    class="mb-6 flex items-center justify-between rounded-2xl border border-white/5 bg-slate-900/80 p-4">
                    ...
                    <div class="rounded-full bg-indigo-500/10 px-4 py-2 text-xs font-semibold text-indigo-300">

                        Live Payroll Analytics
                ...
                <div class="grid gap-6 lg:grid-cols-3">
                    ...
                    <div class="rounded-3xl border border-white/10 bg-slate-900/70 p-6 text-left">
    ...
    <section id="features" class="mx-auto max-w-7xl px-6 pb-24">
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            ...
            <!-- Feature -->
            <div
                class="rounded-[2rem] border border-white/10 bg-white/5 p-8 backdrop-blur-xl transition hover:-translate-y-1 hover:bg-white/[0.07]">

                <div
                    class="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-500/10 text-indigo-300">
            ...
            <div
                ...
                <div class="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-cyan-500/10 text-cyan-300">
            ...
            <div
                ...
                <div
                    class="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-violet-500/10 text-violet-300">
            ...
            <div
                ...
                <div
                    class="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-500/10 text-emerald-300">
